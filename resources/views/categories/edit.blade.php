      ...
      <div class="card-body">
          <form method="POST" action="/categories/edit/{{$id}}" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6">
                       <textarea id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required autofocus  rows="3">
                         {{$cat->description}}
                       </textarea>
              ...
              <div class="form-group">
                <div class="form-group row">
                    <label for= "" class="col-md-4 col-form-label text-md-right">Parent Category:</label>
                    <div class="col-md-6">
                      <div class="form-group">
